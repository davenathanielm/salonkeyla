                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col mt-4">
                                ...
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalLayanan">
                                    Layanan
                                </button>
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalCust">
                                    Pelanggan
                                </button>
                            </div>
                        </div>
...
<script>
    ...
    $(document).on('click', '.hapus_cart', function() {
        var row_id = $(this).attr("id");
        $.ajax({
            url: "<?= base_url('jual/deleteCart') ?>/" + row_id,
            method: "DELETE",
