...
<main>
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="<?= base_url('users/edit/' . $result['Id']) ?>" method="POST" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="text" class="form-control <?= $validation->hasError('firstname') ? 'is-invalid'
                                                                        : '' ?>" id="firstname" name="firstname" value="<?= old('firstname', $result['firstname']) ?>">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="text" class="form-control <?= $validation->hasError('lastname') ? 'is-invalid'
                                                                        : '' ?>" id="lastname" name="lastname" value="<?= old('lastname', $result['lastname']) ?>">
                            <div id="validationServer03Feedback" class="invalid-feedback">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="text" class="form-control <?= $validation->hasError('username') ? 'is-invalid'
                                                                        : '' ?>" id="username" name="username" value="<?= old('username', $result['user_name']) ?>">
                            <div id="validationServer03Feedback" class="invalid-feedback">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="text" class="form-control <?= $validation->hasError('email') ? 'is-invalid'
                                                                        : '' ?>" id="email" name="email" value="<?= old('email', $result['user_email']) ?>">
                            <div id="validationServer03Feedback" class="invalid-feedback">
