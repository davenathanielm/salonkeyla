        ...
        <tbody id="myTable">
            ...
            foreach ($result as $value) : ?>
                <tr>
                    ...
                    <td>
                        <a class="btn btn-warning" href="<?= base_url('Layanan/edit/' . $value['Id_Layanan']) ?>" role="button">Update</a>

                        <form action="<?= base_url('Layanan/delete/' . $value['Id_Layanan']) ?>" method="post" class="d-inline">
